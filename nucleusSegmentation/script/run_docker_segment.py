...
def print_help_segment():
    print 'run_docker_segment segment <docker name> <tissue image file> <output zip file> <other arguments> '
...
def run_segment(argv, docker_name, inp_file, zip_file):
    ...
    tmp_input = "/tmp/input" + repr(rnd_val)
    tmp_output = "/tmp/output" + repr(rnd_val)
    tmp_zip = "/tmp/zip" + repr(rnd_val)
